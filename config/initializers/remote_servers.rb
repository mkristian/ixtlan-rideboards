...
Rideboards::Application.config.rest.server( :translations ) do |server|
  ...
  server.add_model( Ixtlan::Gettext::TranslationKey, config[:translation_keys_path] || "translation_keys" )
end
